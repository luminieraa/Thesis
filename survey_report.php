...
<div class="col-lg-12">
	<div class="d-flex w-100 justify-content-center align-items-center mb-2">
		<label for="" class="control-label text-red">Find Survey</label>
		<div class="input-group input-group-sm col-sm-5">
          <input type="text" class="form-control" id="filter" placeholder="Enter keyword...">
          <span class="input-group-append">
            <button type="button" class="button button1 text-yellow btn btn-primary btn-flat" id="search">Search</button>
          </span>
        </div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-3 py-1 px-1 survey-item">
			<div class="card card-outline card-primary text-red">
              ...
              <div class="card-body" style="display: block;">
               ...
               <div class="row">
               	...
               	<div class="d-flex justify-content-center w-100 text-center text-red">
               			<a href="index.php?page=view_survey_report&id=<?php echo $row['id'] ?>" class="button button1 text-yellow btn btn-sm"><i class="fa fa-poll text-yellow"></i> View Report</a>
               	</div>
               </div>
              </div>
            </div>
