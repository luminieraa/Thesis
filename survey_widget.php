	...
	<div class="d-flex w-100 justify-content-center align-items-center mb-2">
		...
		<div class="input-group input-group-sm col-sm-5">
          ...
          <span class="input-group-append">
            <button type="button" class="button button1 btn btn-primary btn-flat" id="search">Search</button>
          </span>
        </div>
	</div>
               ...
               <div class="row ">
               	...
               	<div class="d-flex justify-content-center w-100 text-center">
               		<?php if(!isset($ans[$row['id']])): ?>
               			<a href="index.php?page=answer_survey&id=<?php echo $row['id'] ?>"class="button button1 text-yellow btn btn-sm"><i class="fa fa-pen-square text-yellow"></i> Take Survey</a>
               		<?php else: ?>
               			<p class="text-primary border-top border-primary text-red">Done</p>
               		<?php endif; ?>
               	</div>
               </div>
              </div>
