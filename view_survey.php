	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<h3 class="card-title text-red">Survey Details</h3>
				</div>
		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				<div class="card-header">
					<h3 class="card-title"><p style="color:red"> <b>Survey Questionaire</b></h3></p>

					<div class="card-tools text-red">

						<button class="button text-yellow btn btn-block btn-sm btn-default btn-flat border-success new_question" type="button"><i class="fa fa-plus"></i> Add New Question</button>
					</div>
				</div>
				<form action="" id="manage-sort">
				<div class="card-body ui-sortable text-red">
					<?php
					...
					<div class="callout callout-info">
						...
						<?php else: ?>
							<div class="form-group">
								<textarea name="answer[<?php echo $row['id'] ?>]" id="" cols="30" rows="4" class="form-control text-red" placeholder="Write Something Here..."></textarea>
							</div>
						<?php endif; ?>
						</div>
					</div>
