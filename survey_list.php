	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="button text-yellow btn btn-block btn-sm btn-default btn-flat border-primary" href="./index.php?page=new_survey"><i class="fa fa-plus text-yellow"></i> Add New Survey</a>
			</div>
		</div>
		<div class="card-body">
			<table class="table tabe-hover table-bordered text-red" id="list">
				<colgroup>
					<col width="5%">
					<col width="20%">
					<col width="20%">
				...
				<tbody>
					...
					<tr>
						...
						<td><b class="truncate text-red"><?php echo $row['description'] ?></b></td>
