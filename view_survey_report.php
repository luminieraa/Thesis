	...
	<div class="row">
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<h3 class="card-title text-red"><b>Survey Details</b></h3>
		...
		<div class="col-md-8">
			<div class="card card-outline card-success">
				<div class="card-header">
					<h3 class="card-title text-red"><b>Survey Report</b></h3>
					<div class="card-tools">
						<button class="button text-yellow btn btn-flat btn-sm " type="button" id="print"><i class="fa fa-print text-yellow"></i> Print</button>
					</div>
				</div>
				<div class="card-body ui-sortable">
					...
					?>
					<div class="callout callout-info text-red">
